...
const bassLessons = [
  {
    title: "Bass Anatomy & Setup",
    description: "Learn the parts of the bass and proper instrument setup for comfortable playing.",
    difficulty: "Beginner",
    duration: "15 min",
    thumbnail: "https://i.pinimg.com/1200x/fc/08/d5/fc08d50361dfcd4ef84fee3cafe85e3e.jpg"
  },
  {
    title: "Finger Technique & Posture",
    description: "Master proper hand positioning, finger formation, and body posture for bass playing.",
    difficulty: "Beginner",
    duration: "18 min",
    thumbnail: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?q=80&w=800"
  },
  {
    title: "Basic Notes & Scales",
    description: "Learn the bass fretboard and play your first scales with proper technique.",
    difficulty: "Beginner",
    duration: "20 min",
    thumbnail: "https://images.unsplash.com/photo-1510915361894-db8b60106cb1?q=80&w=800"
  },
  {
    title: "Reading Tab & Notation",
    description: "Understand tablature and standard notation to play bass lines from sheet music.",
    difficulty: "Beginner",
    duration: "22 min",
    thumbnail: "https://images.unsplash.com/photo-1507838153414-b4b713384a76?q=80&w=800"
  },
  {
    title: "Groove & Rhythm Patterns",
    description: "Develop your sense of pocket and learn essential bass groove patterns.",
  ...
  },
  {
    ...
    description: "Record and refine your bass playing for confident musical performance.",
    difficulty: "Intermediate",
    duration: "20 min",
    thumbnail: "https://images.unsplash.com/photo-1508739773434-c26b3d09e071?q=80&w=800"
  },
];

export default function BassDashboard() {
  ...
  const isLessonCompleted = (idx: number) => {
    ...
    return progress.some(p => p.lessonId === `bass-${idx + 1}`);
  };

  const progressPercent = progress && Array.isArray(progress)
    ? Math.round((progress.filter(p => p.completed && p.lessonId.startsWith("bass-")).length / bassLessons.length) * 100)
    : 0;
    ...
    <div className="min-h-screen bg-[#0d0d0d] text-slate-300 font-sans antialiased">
      ...
      <main className="w-full">
        <section className="relative h-[65vh] min-h-[500px] bg-[#111] overflow-hidden group flex flex-col justify-center border-b border-white/5">
          <img 
            src="https://i.pinimg.com/736x/1d/69/9c/1d699ca7aeb82d32f0ada067b04192b4.jpg" 
          ...
          <div className="relative z-10 px-8 md:px-16 lg:px-24 max-w-5xl">
            <div className="flex items-center gap-3 text-[#ff5a00] text-[10px] font-bold uppercase tracking-[0.5em] mb-6">
              <Music size={14} /> Bass Mastery Series
            </div>
            <h1 className="text-6xl lg:text-7xl font-medium text-white mb-8 tracking-tighter leading-none">
              Bass <br/><span className="italic font-light opacity-80 text-5xl lg:text-6xl text-slate-400">Foundations.</span>
            </h1>
            <p className="text-lg text-slate-400 font-medium leading-relaxed mb-10 max-w-xl">
              From the first note to locked-in grooves. Master the pulse that holds music together.
            </p>
        ...
        <section ref={curriculumRef} className="px-8 md:px-16 lg:px-24 py-24 bg-[#0d0d0d]">
          <div className="flex items-end justify-between mb-20 border-b border-white/5 pb-10">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-2 font-medium uppercase tracking-widest">Bass Beginner Path</p>
            </div>
            ...
            {bassLessons.map((lesson, idx) => (
              <div key={idx} className="group flex flex-col md:flex-row items-center gap-12 py-10 border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-all px-6 -mx-6 rounded-3xl">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <Link
                    href={`/dashboard/student/bass/lesson-${idx + 1}`}
